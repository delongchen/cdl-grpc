...
const (
	...
	LoginStatus_INTERNAL_ERROR  LoginStatus = 3
)
...
var file_auth_user_proto_rawDesc = []byte{
	...
	0x15, 0x0a, 0x0b, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x06,
	0x0a, 0x02, 0x4f, 0x4b, 0x10, 0x00, 0x2a, 0x58, 0x0a, 0x0b, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x53,
	...
	0x57, 0x4f, 0x52, 0x44, 0x5f, 0x45, 0x52, 0x52, 0x4f, 0x52, 0x10, 0x02, 0x12, 0x12, 0x0a, 0x0e,
...
var file_auth_user_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
...
var file_auth_user_proto_depIdxs = []int32{
	...
	2, // 1: auth.User.Login:input_type -> auth.LoginRequest
	3, // 2: auth.User.Login:output_type -> auth.LoginResponse
